  ...
  return <section id="manifesto" className="essence-editorial" ref={root} aria-labelledby="essence-title">
    <div className="essence-stage">
      ...
      <svg className="essence-thread essence-thread-desktop" viewBox="0 0 1440 740" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl`} cx="30%" cy="25%"><stop stopColor="#faf5e9"/><stop offset=".5" stopColor="#b6a186"/><stop offset="1" stopColor="#78644f"/></radialGradient></defs>
      ...
      <svg className="essence-thread essence-thread-mobile" viewBox="0 0 400 900" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl-mobile`} cx="30%" cy="25%"><stop stopColor="#faf5e9"/><stop offset=".5" stopColor="#b6a186"/><stop offset="1" stopColor="#78644f"/></radialGradient></defs>
      ...
      <figure className="essence-smile" data-essence-motion="photo">
        <Image src="/images/resultado-labios.webp" alt="Detalhe de lábios em registro enviado para a Dra. Stefani Melo." fill sizes="(max-width:700px) 88vw, (max-width:1100px) 45vw, 42vw"/>
      </figure>
      ...
      <div className="essence-editorial-copy">
        ...
        <p className="essence-editorial-description" data-essence-motion="fade" data-delay="350">A sua beleza está nos detalhes que fazem de você única. Valorizar seus traços é respeitar sua expressão, suas proporções e a sua história.</p>
