...
function ImageSeal({ id }: { id: string }) {
  ...
  return <svg className={styles.seal} viewBox="0 0 126 126" aria-hidden="true" focusable="false">
    ...
    <text className={styles.sealMark} x="63" y="74" textAnchor="middle">sm.</text>
  </svg>;
}
  ...
  return <section ref={root} className={styles.root} aria-labelledby="experience-statement-title">
    ...
    <figure className={styles.photo} data-experience-motion="photo">
      <Image
        ...
        alt="Retrato da Dra. Stefani Melo"
        fill
      ...
      <p className={styles.photoCopy} data-experience-motion="photo-copy">BELEZA<br />COM A SUA<br />IDENTIDADE.<span aria-hidden="true" /></p>
      <ImageSeal id={uid} />
    </figure>
    ...
    <div className={styles.quote} data-experience-motion="quote">
      ...
      <div>
        ...
        <footer><span aria-hidden="true" /><span>O NOSSO OLHAR</span></footer>
      </div>
    </div>
